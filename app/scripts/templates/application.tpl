<link rel="stylesheet" href="styles/vendor/bootstrap.min.css" >
	<div class="row-fluid">
		<div class="hero-unit">
			...
			<h1>Backbone Responsive 3d Page Transitions</h1>

			<h5>CSS3 3d hardware accelerated page transitions optimised for fluid layouts</h5>
			<h5>Works on Android 2.1+, iPhone 2+, iPad, Chrome 12+, Safari 4+</h5>
			<h5>Require.js AMD compatible</h5>
			<br>
			<h5>Backbone Plugin - Base Router Class you extend from instead of Backbone.Router</h5>
			...
			<div class="row-fluid">
				<div class="span4">
					<p><a href="https://github.com/techjacker/Backbone-Responsive-3d-Page-Transitions" class="btn btn-primary btn-large">Download Plugin @ Github</a> </p>
				</div>
				<div class="span4">
					<!-- <h5><a href="https://github.com/techjacker/Backbone-Responsive-3d-Page-Transitions">Full documentation on github</a></h5> -->
				</div>
			</div>
			</h5>
		</div>
	...
	<div class="row-fluid">
		...
		<h2>CSS Framework Compatible</h2>
		<h5><a href="https://github.com/techjacker/Backbone-3d-Page-Transitions-CSS-Frameworks-Demos">All code used for the demos is available at the github repo &raquo;</a></h5>
		<div class="span12">
